...
<MSG_CONFIG>
  <MS pmsg="2147 - PEDIDO ANULAÇÃO OPERAÇÃO C/ CARTÃO PENDENTE (REPRESENTANTE)">
	<BL n="MASTER">
		<EL n="CodMsg">
		  <Fv fi="0">
			<P v="#c#ascii" />
    ...
    <BL n="Pagamento Servicos Compra MB-0P0">
      <Fr fi="3">
        <P v="#c#0P0" />
        <P v="#uv#CodTrn" />
        <P v="#uv#CompDadosV" />
    ...
    <BL n="Devolução Compras Outras-016,066,094">
      <Fr fi="3">
        <P v="#c#016,066,094" />
        <P v="#uv#CodTrn" />
        <P v="#uv#CompDadosV" />
