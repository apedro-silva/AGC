...
namespace SF.Expand.Switch.Clearing
{
    ...
    /// </summary>
    public class CLN5 : OrchPipeComponent
    {
        /// <summary>
        /// Runs the component.
        /// </summary>
        ...
        public override void RunComponent(IOrchWrkData OrchWrkData, string[] Params)
        {
            ...
            try
            {
                ...
                while ((line = sr.ReadLine()) != null)
                {
                    ...
                    DoParseLine(State, line, "CLN5_TIPREG_" + TIPREG);
                    ...
                    if (TIPREG == "9")
                    {
                        ...
                        if (i != Convert.ToInt32(TOTREG))
                            throw new BusinessException("CLN5.RunComponent->TOTREG <> Registos no ficheiro!");
                        break;
                    }
            ...
            finally
            {
                ...
                finJE.RunComponent(State.OrchWrkData, new string[] { "JEFicheiroEMIS", "V02" });
            }
        }
        ...
        private void ProcessCard(OrchPipeComponent.ComponentState State, string line)
        {
            ...
            try
            {
                ...
                string NumCartao = State.OrchWrkData.GetWrkData().ReadNodeValue("PAN", true);
                ...
                switch (TIPREG)
                {
                    ...
                    case "2":
                        ...
                        break;
                    // if TIPREG=3 -> cartões de outras entidades capturados em equipamento do banco
                    case "3": 
                        //State.OrchWrkData.GetWrkData().WriteNodeValue("CodTrn", "EJ1", true);
                        //State.OrchWrkData.GetWrkData().WriteNodeValue("DescricaoServico", "Registo Tipo 3 CLN5", true);
                        break;
                    case "4": break;
                    case "9": RowsAffected = -1; break;
                    default:
                        State.OrchWrkData.GetWrkData().WriteNodeValue("CodTrn", "00", true);
                        State.OrchWrkData.GetWrkData().WriteNodeValue("TextoErro", "Tipo registo " + TIPREG + " no CLN5 não suportado", true);
                        return;
                }
            }
            catch (Exception)
