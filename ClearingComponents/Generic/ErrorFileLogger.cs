...
namespace SF.Expand.Switch.Clearing
{
    ...
    /// </summary>
    public class ErrorFileLogger : OrchPipeComponent
    {
        /// <summary>
        /// Runs the component.
        /// </summary>
            ...
            try
            {
                ...
                while ((line = sr.ReadLine()) != null)
                {
                    ...
                    if (TipoRegisto == "0")
                    {
                        ...
                        DoParseLine(State, line, "ERROR_TIPREG_0");

                        string Ficheiro = State.OrchWrkData.GetWrkData().ReadNodeValue("Fich", true);
                        switch (Ficheiro)
                        {
                            case "EERR": State.OrchWrkData.GetWrkData().WriteNodeValue("CodTrn", "V07", true); break;
                            case "ECCF": State.OrchWrkData.GetWrkData().WriteNodeValue("CodTrn", "V08", true); break;
                            default: break;
                        }
                    ...
                    else if (TipoRegisto == "9")
                    {
                        ...
                        DoParseLine(State, line, "ERROR_TIPREG_9");
                    }
                }
