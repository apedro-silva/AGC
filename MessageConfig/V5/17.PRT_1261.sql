...
<MSG_CONFIG>
  <MS cmsg="1261 - RESPOSTA AO PEDIDO DE OPERAÇÃO COM CARTÃO (EMISSOR)">
    <BL n="Header">
      <EL n="CodMsg">
        <Fv fi="0">
          <P v="#c#1261" />
    ...
    <BL n="Dados variaveis">
      <BL n="008-transferência entre contas do cartão">
        <Fr fi="3">
          <P v="#uv#CodTrn" />
          <P v="#c#008" />
        </Fr>
      ...
      <BL n="502-emissão de cheques-incompleto">
        <Fr fi="3">
          <P v="#uv#CodTrn" />
          <P v="#c#502" />
        </Fr>
      ...
      <BL n="031-levantamento a crédito">
        <Fr fi="3">
          <P v="#uv#CodTrn" />
          <P v="#c#031" />
        </Fr>
      ...
      <BL n="Resposta-001,005,009,010">
        <Fr fi="3">
          <P v="#uv#CodTrn" />
          <P v="#c#001,005,009,010" />
        </Fr>
        <BL n="Header">
          <EL n="CompDadosV">
            <Fv fi="0">
