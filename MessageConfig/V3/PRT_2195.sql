...
<MSG_CONFIG>
  <MS pmsg="2195 - Pedido de Anulação de Operação com NBA">
    <EL n="CodMsg">
      <Fv fi="0">
        <P v="#c#ascii" />
        <P v="#uv#CodMsg" />
    ...
    <EL n="NIBDestinatario">
      <Fv fi="0">
        <P v="#c#ascii" />
        <P v="#uv#NIBDestinatario" />
        <P v="#c#21" />
        <P v="#c#1" />
      </Fv>
    </EL>
    ...
    <EL n="NrIdRespOriginal">
      <Fv fi="0">
        <P v="#c#ascii" />
        <P v="#uv#NrIdRespOriginal" />
        <P v="#c#14" />
        <P v="#c#1" />
      </Fv>
    </EL>
    <EL n="AplicPddOriginal">
      <Fv fi="0">
        <P v="#c#ascii" />
    ...
    <EL n="DhMsgOriginal">
      <Fv fi="0">
        <P v="#c#ascii" />
        <P v="#uv#DhMsgOriginal" />
        <P v="#c#14" />
        <P v="#c#1" />
      </Fv>
    </EL>
    <EL n="MotAnulOriginal">
      <Fv fi="0">
        <P v="#c#ascii" />
        <P v="#uv#MotAnulOriginal" />
        <P v="#c#1" />
        <P v="#c#1" />
      </Fv>
    </EL>
