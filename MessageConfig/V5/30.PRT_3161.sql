...
<MSG_CONFIG>
  <MS pmsg="3161 - Pedido de Operação com Cartão Pendente(Emissor)">
    <BL n="MASTER">
      <EL n="CodMsg">
        <Fv fi="0">
          <P v="#c#ascii" />
    ...
    <BL n="Pagamento Servicos Compra MB-009,0P0">
      <Fr fi="3">
        <P v="#c#009,0P0" />
        <P v="#uv#CodTrn" />
        <P v="#uv#CompDadosV" />
    ...
    <BL n="Devolução Compras Outras-016,026,027,066,094,095">
      <Fr fi="3">
        <P v="#c#016,026,027,066,094,095" />
        <P v="#uv#CodTrn" />
        <P v="#uv#CompDadosV" />
      </Fr>
      <EL n="VerDadosV">
    ...
    <BL n="Confirmação Emissao Cheques-532">
      <Fr fi="3">
        <P v="#c#532" />
        <P v="#uv#CodTrn" />
        <P v="#uv#CompDadosV" />
