...
{
    public class ProcessERMBFile : OrchPipeComponent
    {
        public override void RunComponent(IOrchWrkData OrchWrkData, string[] Params)
        {
            ...
            {
                State.LastError = new BusinessException("ERMB.ProcessFile", exp);
            ...
            finally
            {
                ...
                finJE.RunComponent(State.OrchWrkData, new string[] { "JEFicheiroEMIS", "E4" });
        ...
        private void ProcessFileTrailer(OrchPipeComponent.ComponentState State, string ERMBLine, string FICH)
        {
            ...
            switch (FICH)
            {
                case "EDST": FileName = State.OrchWrkData.GetWrkData().ReadNodeValue("EDSTFileName"); break;
                case "EORI": FileName = State.OrchWrkData.GetWrkData().ReadNodeValue("EORIFileName"); break;
                case "CCLN": FileName = State.OrchWrkData.GetWrkData().ReadNodeValue("CCLNFileName"); break;
                default:
