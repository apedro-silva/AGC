...
<MSG_CONFIG>
  <MS pmsg="2137 - PEDIDO DE ANULAÇÃO DE OPERAÇÃO C/ CARTÃO PENDENTE (ACQUIRER)">
	<BL n="MASTER">
		<EL n="CodMsg">
		  <Fv fi="0">
			<P v="#c#ascii" />
    ...
    <BL n="Pagamento Servicos Compra MB-0P0,0P7">
      <Fr fi="3">
        <P v="#c#0P0,0P7" />
        <P v="#uv#CodTrn" />
        <P v="#uv#CompDadosV" />
    ...
    <BL n="Devolução Compras Outras-016,094">
      <Fr fi="3">
        <P v="#c#016,066,094" />
        <P v="#uv#CodTrn" />
        <P v="#uv#CompDadosV" />
